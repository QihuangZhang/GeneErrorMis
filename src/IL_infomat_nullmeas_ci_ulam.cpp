...
// [[Rcpp::export]]
NumericMatrix IL_infomat_nullmeas_ci_ulam(NumericVector w, NumericVector v, NumericVector Y1star, NumericVector Y2star, NumericMatrix Covariates, int isY2in, NumericMatrix CovMis2,  NumericVector R, 
                                    NumericVector beta1, NumericVector beta2, double lambda, double gamma, NumericVector alpha1, NumericVector alpha0,
  ...
  const int indexlambda = indexbeta2+1;
