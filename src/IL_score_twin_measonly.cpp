...
// [[Rcpp::export]]
NumericVector IL_score_twin_measonly(NumericVector w, NumericVector v, NumericVector Y1star, NumericVector Y2star, NumericMatrix Covariates, int isY2in, NumericMatrix CovMis2, double rho,  
  ...
  double eta2exp,Cov_meas11_1p,Cov_meas11_2p,mta_11_1p,mta_11_2p,random1,random2;
  double fip_p1,fip_p2,f2i,f1i,weightjk;
  double ui11,ui12,ui2,uk1,uk2;
